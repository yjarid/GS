...
<div class="fep-announcementbox-search-form-div">
	<form id="fep-announcementbox-search-form" action="">
		...
		<input type="search" name="fep-search" class="fep-announcementbox-search-form-field GS-search" value="<?php echo isset( $_GET['fep-search'] ) ? esc_attr( $_GET['fep-search'] ) : ''; ?>" placeholder="<?php esc_html_e( 'Search Announcements', 'front-end-pm'); ?>" />
		...
		<div>
			...
			<div class="GS-bulk-action-grid">
				...
				<div>
					...
					<button type="submit" class="fep-button GS-messageBox-submit" name="fep_action" value="announcement_bulk_action"><?php esc_html_e( 'Apply', 'front-end-pm' ); ?></button>
				</div>
			</div>
